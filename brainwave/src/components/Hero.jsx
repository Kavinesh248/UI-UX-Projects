          ...
          <div className="bg-conic-gradient relative z-1 rounded-2xl p-0.5">
            <div className="bg-n-8 relative rounded-[1rem]">
              ...
              <div className="aspect-[33/40] overflow-hidden rounded-b-[0.9rem] md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <Generating className="absolute right-4 bottom-5 left-4 md:right-auto md:bottom-8 md:left-1/2 md:w-[31rem] md:-translate-x-1/2" />

                <ScrollParallax isAbsolutelyPositioned>
                  <ul className="bg-n-9/40 border-n-1/10 absolute bottom-[7.5rem] -left-[5.5rem] hidden rounded-2xl border px-1 py-1 backdrop-blur xl:flex">
