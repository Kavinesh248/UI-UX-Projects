...
const Header = () => {
  ...
  return (
    <div
      className={`border-n-6 lg:bg-n-8/90 fixed top-0 left-0 z-50 w-full border-b ${
    ...
    >
      <div className="flex items-center px-5 max-lg:py-4 lg:px-7.5 xl:px-10">
        ...
        <nav
          ...
          } bg-n-8 fixed top-[5rem] right-0 bottom-0 left-0 lg:static lg:mx-auto lg:flex lg:bg-transparent`}
        >
